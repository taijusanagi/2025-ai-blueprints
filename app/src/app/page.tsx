    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-black text-slate-200 flex flex-col items-center px-4 sm:px-6 pt-0 relative">
      ...
      <section className="text-center max-w-4xl pt-24 md:pt-32 z-10 w-full">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <Button
            ...
            asChild
          >
             <Link href="https://github.com/taijusanagi/2025-ai-blueprints" target="_blank" rel="noopener noreferrer">
               GitHub
             </Link>
          </Button>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-24 md:mt-32 max-w-6xl w-full z-10 px-4">
        {[
          ...
          <Card key={index} className="group bg-slate-800/90 border border-slate-700/50 rounded-lg transition-all duration-300 ease-in-out hover:border-slate-600 hover:bg-slate-800 hover:-translate-y-1 shadow-md hover:shadow-lg">
